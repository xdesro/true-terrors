...
But I think rather than "people are too emotional or angry about AI", the more salient point to arrive at is something else. Love it or hate it, a lot of the tech under the AI umbrella have well-documented trade-offs and outright harms. It's fairly reasonable, then, to accept that most folks insist upon "solutions that don't knowingly create new problems", especially given that the world looks _\*gestures wildly at everything\*_ like _this_, these days.

{% renderTemplate 'webc' %}
<embed-card :external="true" title="AI data centres can warm surrounding areas by up to 9.1°C" url="https://www.newscientist.com/article/2521256-ai-data-centres-can-warm-surrounding-areas-by-up-to-9-1c/" author="New Scientist" :show-url="false">
...
I'm sure it's clear from this note, but I'm generally AI-skeptical (though I do try not to be dogmatic about that position) — if you're into that point of view, I've written more about the implications of a technology like LLMs, specifically from a labor angle, [elsewhere on the blog](https://henry.codes/writing/economics-and-labor-rights-in-ai-skepticism/).

{% renderTemplate 'webc', { collectionsAll: collections.all } %}

<embed-card :post="findPostByPath(collectionsAll, 'writing/economics-and-labor-rights-in-ai-skepticism/')"></embed-card>
